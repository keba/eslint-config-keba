...
module.exports = {
  ...
  rules: {
    ...
    'no-negated-in-lhs': [
      // disallow negation of the left operand in `in` expressions [recommended]
      'error'
    ],
    'no-obj-calls': [
    ...
    'no-shadow-restricted-names': [
      // disallow sidentifiers from shadowing restricted names
      'error'
    ],
    'no-undef': [
    ...
    'jsx-quotes': [
      // enforce the ocnsistent use of either double or single quotes in JSX attributes [fixable]
      'error',
      'prefer-double'
    ],
    'key-spacing': [
    ...
    'newline-after-var': [
      // require or disallow an empty newline after `var` declarations
      'off',
      'always'
    ],
    ...
    'no-spaced-func': [
      // disallow spacing between `function` identifiers and applications [fixable]
      'error'
    ],
    'no-ternary': [
    ...
    'object-property-newline': [
      // enforce placing object properties on seperate lines
      'error',
    ...
    'sort-vars': [
      // rquire variables within the same declaration block to be sorted
      'error',
      {ignoreCase: true}
    ],
    'space-before-blocks': [
